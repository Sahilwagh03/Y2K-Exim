...
export default function Clients() {
  const row1Logos = [
    ...
    { src: "/img/clients/spartan.png", alt: "Spartan Engineering Client Logo" },
    { src: "/img/clients/transparentoverseas.png", alt: "Transparent Overseas Client Logo" },
    { src: "/img/clients/maruti.svg", alt: "Maruti Suzuki Client Logo" },
    { src: "/img/clients/parle-elizabeth.webp", alt: "Parle Elizabeth Tools Pvt Ltd Client Logo" },
    { src: "/img/clients/haldia-petrochem.png", alt: "Haldia Petrochem Ltd Client Logo" },
    { src: "/img/clients/sunpharma.png", alt: "Sunpharma Ltd Client Logo" },
    { src: "/img/clients/indoco.png", alt: "Indoco Remedies Ltd Client Logo" },
    { src: "/img/clients/cachet-pharma.jpg", alt: "Cachet Pharma Ltd Client Logo" },
    { src: "/img/clients/toshiba-jsw.svg", alt: "Toshiba JSW Ltd Client Logo" },
  ];

  const row2Logos = [
    { src: "/img/clients/topsail.avif", alt: "Topsail Appliances Pvt Ltd Client Logo" },
    { src: "/img/clients/schwabe.png", alt: "Dr Willmar Schwabe Herbal Client Logo" },
    { src: "/img/clients/manaksia.gif", alt: "Manaksia Aluminum Corporation Client Logo" },
    { src: "/img/clients/rasayan.png", alt: "Rasayan Flavour and Fragrances Client Logo" },
    { src: "/img/clients/alkem.svg", alt: "Alkem Pharma Client Logo" },
    { src: "/img/clients/intas.png", alt: "Intas Pharma Client Logo" },
    { src: "/img/clients/anand-mechanical.svg", alt: "Anand Mechanical Works Pvt Ltd Client Logo" },
    { src: "/img/clients/ceramin.png", alt: "Ceramin India Pvt Ltd Client Logo" },
    { src: "/img/clients/ashiana-exports.svg", alt: "Ashiana Exports Private Limited Client Logo" },
    { src: "/img/clients/tovec-pharma.jpg", alt: "Tovec Pharma Pvt Ltd Client Logo" },
