...
export const metadata: Metadata = {
  title: "Corporate GST & Income Tax Advisory Services | CA Consultants India",
  description:
    "Comprehensive corporate tax and GST advisory services by Y2K Exim. GST registration, GSTR filing, refund claims, Income Tax audits, and indirect tax compliance across India.",
  alternates: {
    canonical: "/Taxation",
  },
  openGraph: {
    title: "GST & Income Tax Services Hub | Y2K Exim",
    description:
