...
export const metadata: Metadata = {
  title: "Contact Us | Y2K Exim Offices in Mumbai, Gujarat, Chennai & Kolkata",
  description:
    "Get in touch with Y2K Exim Services Pvt Ltd. Connect with our corporate headquarters in Belapur Navi Mumbai or branch offices in Gujarat, Chennai, and Kolkata for DGFT, Customs (CHA), and Subsidy advisory.",
  alternates: {
    canonical: "/contact-us",
  },
  openGraph: {
    title: "Contact Us | Y2K Exim Services Pvt Ltd",
    description:
