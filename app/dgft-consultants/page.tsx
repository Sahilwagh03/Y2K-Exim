...
export default function DGFTConsultantsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 flex flex-col font-sans select-none pb-20">
      {/* Light Premium Hero Section - Structured, Natural, Stripe-Inspired */}
      ...
      {/* Main Content Area - Categorized grid layout */}
      <main className="max-w-[1440px] mx-auto w-full px-4 md:px-8 py-6">
        
        {/* Grouped sections representing the hierarchy */}
                    ...
                    <div className="space-y-4 pl-1">
                      {subGroup.services.map((service) => {
                        ...
                        return (
                          ...
                          >
                            {/* Clean Accent Line on Left when expanded */}
                            {isExpanded && (
                            ...
                            {isExpanded && (
                              <div className="border-t border-slate-100/80 bg-slate-50/10 p-5 md:p-6 pl-6 space-y-6 animate-popup-fade select-text">
                                ...
                                {/* Left and Right Details Section Grid */}
                                ...
                                {/* Info specifications table / bar at bottom */}
